...
{{ Form::open(['route' => ['dashboard.facility.store', ['setter_id'=>$setter]], 'files' => true]) }}
<div class="row">
            ...
            <div class="box-body">
                <div class="row">
                    ...
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::text('space',old('space'),['id'=>'space','required' => 'required','class' => 'form-control']) }}
                    ...
                    <div class="form-group margin-bottom20 col-md-6">
                        ...
                        {{ Form::number('num_of_rooms',old('num_of_rooms'),['id'=>'num_of_rooms','required' => 'required','class' => 'form-control']) }}
