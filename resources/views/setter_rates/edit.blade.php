...
{{ Form::open(['route' => ['dashboard.setter_rate.update',$setter_rate->id],'method' => 'PATCH','files'=>'true','enctype'=>'multipart/form-data']) }}
{{ Form::hidden('setter_rate_id',$setter_rate->id,['id'=>'setter_rate_id','class' => 'form-control']) }}
